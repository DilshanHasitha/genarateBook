...
describe('Options Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'options', component: OptionsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to optionsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOptionsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOptionsIdentifier).toHaveBeenCalledWith(entity);
