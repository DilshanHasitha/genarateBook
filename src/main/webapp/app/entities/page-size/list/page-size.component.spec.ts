...
describe('PageSize Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'page-size', component: PageSizeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PageSizeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pageSizes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to pageSizeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPageSizeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPageSizeIdentifier).toHaveBeenCalledWith(entity);
