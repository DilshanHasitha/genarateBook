...
describe('Styles Management Component', () => {
  let comp: StylesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'styles', component: StylesComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(StylesComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to stylesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStylesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStylesIdentifier).toHaveBeenCalledWith(entity);
