...
describe('LayerGroup Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'layer-group', component: LayerGroupComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.layerGroups?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to layerGroupService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLayerGroupIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLayerGroupIdentifier).toHaveBeenCalledWith(entity);
